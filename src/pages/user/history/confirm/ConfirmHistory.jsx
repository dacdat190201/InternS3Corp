...
import '../all/AllOrder.css';
const ConfirmHistory = ({ props, confirmInfor, convertDate }) => {
    const total = (payload) => {
    ...
    return (
        <>
            <div className="allorder__container">
                {props
                    .filter((item) => item.status.name === 'confirm')
                    .map((item, key) => {
                        return (
                                    ...
                                    <div className="allOrder__button">
                                        ...
                                        <div className="allOrde__button-right">
                                            {item.status.name === 'CONFIRM' ? (
                                                <button className="all__button-buy" onClick={() => confirmInfor(item)}>
                                                    Confirm
                                                </button>
                                            ) : (
