...
function SignIn() {
    ...
    const checkError = (val) => {
        ...
        if (!val.pass || val.pass.length < 5) {
            error.pass = 'Can not Empty or Password is to short';
        }
        return error;
    };
    const handleSubmit = () => {
                ...
                <div>
                    ...
                    <div className="signup-input">
                        <div className="signup__form">
                            <input type="text" placeholder="Username" name="user" onChange={(e) => handleValue(e)} />
                            {error ? (
                                <div
                                    style={{
                                        color: 'red',
                        ...
                        <div className="signIn__btn">
                            <button className="signIn-btnLogin" onClick={handleSubmit}>
                                Login
                            </button>
                            <div>
                                <Link to={'/forgotpassword'} className="forgot_font">
                                    Forgot pass word
                                </Link>
                            </div>
                        </div>
